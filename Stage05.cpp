...
void Stage05::Start(Sound* sound)
{
	...
	m_pSound = sound;
	m_pSound->Stop();
	m_pSound->PlayBGM("Sound/Stage05.mp3");

	m_tBackGround01.Start(L"Image/Stage05/BackGround01.png");
	m_tBackGround02.Start(L"Image/Stage05/BackGround02.png");
	m_tBackGround03.Start(L"Image/Stage05/BackGround03.png");
	...
	m_tMonster01.Start(L"Image/Stage05/Monster01.png");
	m_tMonster02.Start(L"Image/Stage05/Monster02.png");
	m_tMonster03.Start(L"Image/Stage05/Monster03.png");
	m_tBoss.Start(L"Image/Stage05/Boss.png");
	...
	m_MonsterData01 = { 35.0f, 3, 5, 4, 0.5f, 10.0f };
	m_MonsterData02 = { 35.0f, 3, 5, 4, 0.5f, 10.0f };
	m_MonsterData03 = { 40.0f, 3, 5, 4, 0.5f, 10.0f };
