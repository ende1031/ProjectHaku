...
void Stage03::Start(Sound* sound)
{
	...
	m_tBackGround03.Start(L"Image/Stage03/BackGround03.png");
	...
	m_tMonster01.Start(L"Image/Stage03/Monster01.png");
	m_tMonster02.Start(L"Image/Stage03/Monster02.png");
	m_tMonster03.Start(L"Image/Stage03/Monster03.png");
	m_tBoss.Start(L"Image/Stage03/Boss.png");
	...
	m_MonsterData01 = { 35.0f, 2, 4, 4, 0.5f, 10.0f };
	m_MonsterData02 = { 35.0f, 2, 4, 4, 0.5f, 10.0f };
	m_MonsterData03 = { 40.0f, 2, 4, 4, 0.5f, 10.0f };

	LoadMonsters("Data/Stage03Monsters.txt");
...
void Stage03::Update(float deltaTime)
{
	...
	if (m_Player.GetFireCount() > 0)
	{
		...
		if (m_bAppearBoss)
			dynamic_cast<Boss03*>(m_pBoss)->Update(deltaTime);
		...
		if (m_SceneTime > m_MonsterFileData[m_MonsterCounter].time && m_MonsterDataLine > m_MonsterCounter)
		{
			...
			{
			case 0: //보스
				dynamic_cast<Boss03*>(m_pBoss)->Start(m_tBoss, m_pSound);
				m_bAppearBoss = true;
				break;
			case 1:
...
void Stage03::Draw()
{
	...
	if (m_bAppearBoss)
		dynamic_cast<Boss03*>(m_pBoss)->Draw();
