...
void Stage04::Start(Sound* sound)
{
	...
	m_pSound = sound;
	m_pSound->Stop();
	m_pSound->PlayBGM("Sound/Stage04.mp3");

	m_tBackGround01.Start(L"Image/Stage04/BackGround01.png");
	m_tBackGround02.Start(L"Image/Stage04/BackGround02.png");
	m_tBackGround03.Start(L"Image/Stage04/BackGround03.png");
	...
	m_tMonster01.Start(L"Image/Stage04/Monster01.png");
	m_tMonster02.Start(L"Image/Stage04/Monster02.png");
	m_tMonster03.Start(L"Image/Stage04/Monster03.png");
	m_tBoss.Start(L"Image/Stage04/Boss.png");
	...
	m_MonsterData01 = { 35.0f, 3, 6, 4, 0.5f, 10.0f };
	m_MonsterData02 = { 35.0f, 3, 6, 4, 0.5f, 10.0f };
	m_MonsterData03 = { 40.0f, 3, 6, 4, 0.5f, 10.0f };

	LoadMonsters("Data/Stage04Monsters.txt");

	m_pBoss = new Boss04;
}

void Stage04::Update(float deltaTime)
{
	...
	if (m_Player.GetFireCount() > 0)
	{
		...
		if (m_bAppearBoss)
			dynamic_cast<Boss04*>(m_pBoss)->Update(deltaTime);
		...
		if (m_SceneTime > m_MonsterFileData[m_MonsterCounter].time && m_MonsterDataLine > m_MonsterCounter)
		{
			...
			{
			case 0: //보스
				dynamic_cast<Boss04*>(m_pBoss)->Start(m_tBoss, m_pSound);
				m_bAppearBoss = true;
				break;
			case 1:
...
void Stage04::Draw()
{
	...
	if (m_bAppearBoss)
		dynamic_cast<Boss04*>(m_pBoss)->Draw();
